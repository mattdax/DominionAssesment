...
export function isAssetHistoryPoint(
    value: unknown
): value is AssetHistoryPoint {
    if (!isRecord(value)) {
        return false;
    }
...
export function isAssetPrediction(
    value: unknown
): value is AssetPrediction {
    if (!isRecord(value)) {
        return false;
    }
...
export function isAssetTrajectory(
    value: unknown
): value is AssetTrajectory {
    if (!isRecord(value)) {
        return false;
    }
